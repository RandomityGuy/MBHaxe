...
class EndGameGui extends GuiControl {
	...
	public function new(continueFunc:GuiControl->Void, restartFunc:GuiControl->Void, nextLevelFunc:GuiControl->Void, mission:Mission, timeState:TimeState) {
		...
		egResultLeft.text.text = '<p align="right"><font color="#8DFF8D">Time:</font><br/><font color="#88BCEE">Par Time:</font><br/><font color="#EBEBEB">Rating:</font><br/><font color="#EBEBEB">My Best Time:</font></p>';
		...
		egResultRight.text.text = '<font color="#8DFF8D">${Util.formatTime(timeState.gameplayClock)}</font><br/><font color="#88BCEE">${Util.formatTime(mission.qualifyTime)}</font><br/><font color="#EBEBEB">0</font><br/><font color="#EBEBEB">${Util.formatTime(bestScore.time)}</font>';
